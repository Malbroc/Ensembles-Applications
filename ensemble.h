...
Entier __min_rec(Ensemble e, int rang, Entier min);	// Fonction auxiliaire récursive pour le minimum
Entier max(Ensemble e);								// Renvoie l'élément le plus grand de e (prec : e non vide)
Entier __max_rec(Ensemble e, int rang, Entier max);	// Fonction auxiliaire récursive pour le maximum
